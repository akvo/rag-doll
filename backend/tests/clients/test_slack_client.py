...
async def test_start_onboarding(mock_async_web_client, slack_bot_client):
    ...
    mock_async_web_client.chat_postMessage.assert_awaited_once_with(key='value')
    assert slack_bot_client.onboarding_tutorials_sent[
        'channel']['user_id'].timestamp == '1234567890'
